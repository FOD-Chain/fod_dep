...
.directive('simpleSummaryStats', function($http) {
  return {
	...
	$http.get("https://www.fodchain.com/hmm/explorer/market/")
       .then(function(res){
          scope.stats.fluctuation = res.data.fluctuation;
          scope.stats.price = res.data.price;
          scope.stats.cap = res.data.cap;
          scope.stats.exchange = res.data.exchange;
          //console.log(res);
	});
      }
  }
